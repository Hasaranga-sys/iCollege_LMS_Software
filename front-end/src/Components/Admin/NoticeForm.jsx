    ...
    <div>
      <div className="row">
        <div
          ...
          style={{ maxWidth: 900, marginLeft: 180 }}
        >
          <div class="card-body">
              ...
              <div>
                ...
                <div className="row w-50  mx-auto mt-3">
                  ...
                  >
                    ...
                    <option value="SE3060-Application Framework">
                      SE3060-Application Framework
                    </option>
                    <option value="SE3090-Softwre Architecture">
                      SE3090-Softwre Architecture
                    </option>
                  </select>
                </div>
                <div className="row w-50  mx-auto mt-3">
